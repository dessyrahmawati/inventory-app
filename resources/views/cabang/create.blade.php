...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ __('Tambah Cabang') }}</h1>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <form action="{{ route('cabang.store') }}" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="nama_cabang" id="nama_cabang"
                                        class="form-control form-control-lg" value="{{ old('nama_cabang') }}" required>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="alamat_cabang" class="form-label">Alamat Cabang</label>
                                    <input type="text" name="alamat_cabang" id="alamat_cabang"
                                        class="form-control form-control-lg" value="{{ old('alamat_cabang') }}" required>
                                </div>
                                <div class="form-group mb-3">
